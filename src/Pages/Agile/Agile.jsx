...
const Agile = () => {
  ...
  useEffect(() => {
    ...
    const hasAcceptedInvitation = localStorage.getItem("invitationAccepted");
    if (!hasAcceptedInvitation) {
      setIsModalOpen(true);
    }

    // Add event listener to clear localStorage on beforeunload
  ...
  const pendingMembers = members.filter((user) => user.status === "pending");
                    ...
                    {showActiveMembers === true ? (
                      <tbody className=" ">
                        {activeMembers.map((member) => (
                          <tr
                            key={member._id}
                            className="border rounded-lg hover">
                            <td>
            ...
            <div className="modal bg-white">
              <div className="modal-box  border p-8 border-[#A5ECD7] shadow shadow-[#A5ECD7]">
                <h3 className="text-2xl mb-5 ">
                  you have received a team invitation from the
                  <span className="font-bold">Agile3 Team</span>
                </h3>
                <h4 className="text-[#6C7172] mt-8  text-xl">
                ...
                <div className="flex md:justify-between items-center gap-3 mt-9">
                  <Link to="/community">
