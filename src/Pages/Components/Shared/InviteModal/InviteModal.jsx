        ...
        <div className="modal-box  border p-8 border-[#A5ECD7] shadow shadow-[#A5ECD7]">
          ...
          <div className="flex gap-6 mt-8 items-center ">
            ...
            <div>
              ...
              <p className="text-[#6C7172] text-xl mt-1">info@agile3team.com</p>
            </div>
          </div>

          <div className="flex md:justify-between gap-3 mt-9">
            <label className="modal-backdrop z-10" htmlFor="my_modal_9">
              <div onClick={closeModal} className="hover:shadow-2xl border border-[#000000] flex justify-center items-center rounded-full text-[#000000] md:w-[215px] w-28 text-base md:text-xl font-medium md:font-bold h-10 md:h-[55px]">
                Reject
              </div>
            </label>
